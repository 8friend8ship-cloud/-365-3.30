...
if (!(fixture.CONTENT_READY_YN === 'Y' && fixture.APP_READY_YN === 'Y' && fixture.FRONT_EXPOSED_YN === 'Y')) {
  throw new Error('BIBLE365_FIXTURE_FRONT_GATE_FAILED');
}
if (!fixture.TITLE || !fixture.SUMMARY || !fixture.BIBLE_REF || !fixture.BIBLE_TEXT) {
  throw new Error('BIBLE365_FIXTURE_REQUIRED_FIELD_FAILED');
}
