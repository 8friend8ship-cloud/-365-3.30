...
fetch(url).then(res => res.text()).then(text => {
  ...
  console.log('dry:', JSON.stringify(item.dry, null, 2));
  console.log('devotion:', JSON.stringify(item.devotion, null, 2));
  console.log('merged:', JSON.stringify(item.merged, null, 2));
}).catch(console.error);
